...
layout: page
---
Hi there, I am Joni Baboci; a planner, architect and all-around urban enthusiast currently working on getting [getlayer.xyz](https://getlayer.xyz) off the ground.

I spent the last decade working in the public sector, serving as the General Director for Planning and Urban Development for the [City of Tirana](http://www.tirana.al). My previous experiences include stints in the private sector and leading a groundbreaking planning and architecture start-up for the Albanian Government nicknamed [Atelier Albania](http://planifikimi.gov.al/index.php?id=a1r&L=2). I have consulted for various multilateral and cultural institutions including the World Bank and the Triennale of Milano. 
